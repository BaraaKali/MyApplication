...
public class MyServiceNotDoneActivity extends AppCompatActivity
    ...
    ArrayList<ServiceCitizen> arraylistMyNotDoneServices;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arraylistMyNotDoneServices = new ArrayList<>();
        arraylistMyNotDoneServices = GetFromDB.getNotDoneServicesCitizen();
    ...
    private void drawMyServices() {
        ...
        for (int i = 0 ; i < arraylistMyNotDoneServices.size() ; i++) {
